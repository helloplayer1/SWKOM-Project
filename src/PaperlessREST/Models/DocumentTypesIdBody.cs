...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentTypesIdBody {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DocumentTypesIdBody)obj);
        }

        /// <summary>
        /// Returns true if DocumentTypesIdBody instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentTypesIdBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentTypesIdBody other)
        {
        ...
        public static bool operator ==(DocumentTypesIdBody left, DocumentTypesIdBody right)
        {
