...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ApistoragePathsidPermissionsForm)obj);
        }

        /// <summary>
        /// Returns true if ApistoragePathsidPermissionsForm instances are equal
        /// </summary>
        /// <param name="other">Instance of ApistoragePathsidPermissionsForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApistoragePathsidPermissionsForm other)
        {
        ...
        public static bool operator ==(ApistoragePathsidPermissionsForm left, ApistoragePathsidPermissionsForm right)
        {
