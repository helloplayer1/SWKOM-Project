...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DocumentsIdBody)obj);
        }

        /// <summary>
        /// Returns true if DocumentsIdBody instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentsIdBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentsIdBody other)
        {
        ...
        public static bool operator ==(DocumentsIdBody left, DocumentsIdBody right)
        {
